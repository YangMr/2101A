<template>
  <div class="home">
     <ul>
       ...
       <li @click="toPage('/shallow')">shallow</li>
       <li @click="toPage('/readonly')">readonly与shallowReadonly</li>
       ...
       <li @click="toPage('/store')">Vue3中使用vuex</li>
       <li @click="toPage('/rou')">Vue3中实现路由跳转</li>
       <li @click="toPage('/model')">Vue3中实现组件之间数据的双向绑定</li>
       <li @click="toPage('/prod')">Vue3中实现provide和inject的使用</li>
     </ul>
  </div>
</template>
